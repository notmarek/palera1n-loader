...
struct CreditsSheetView: View {
    ...
    var credits: [Person] = [
        Person(name: "Nebula", icon: URL(string: "https://avatars.githubusercontent.com/u/18669106?v=4")!, role: "pokem0n Owner", link: URL(string: "https://github.com/itsnebulalol")!),
        Person(name: "Mineek", icon: URL(string: "https://avatars.githubusercontent.com/u/84083936?v=4")!, role: "pokem0n Owner", link: URL(string: "https://github.com/mineek")!),
        Person(name: "Nathan", icon: URL(string: "https://avatars.githubusercontent.com/u/87825638?v=4")!, role: "pokem0n Developer", link: URL(string: "https://github.com/verygenericname")!),
        Person(name: "llsc12", icon: URL(string: "https://avatars.githubusercontent.com/u/42747613?v=4")!, role: "pokem0n Loader Developer", link: URL(string: "https://github.com/llsc12")!),
    ...
    var body: some View {
        NavigationView {
            ZStack {
                Rectangle()
                    .irregularGradient(colors: pokem0nColorGradients, backgroundColor: pokem0nColorGradients[1], animate: true, speed: 0.5)
                    .blur(radius: 100)
